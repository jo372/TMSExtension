...
let Modal = (function(){
  ...
  let createElement = function() {
    let newElement = createDOMElement('div');
  ...
  let createHeader = function() {
    ...
    let newButtonContainer = createDOMElement('div');

    if (properties.canMinimise) {
      let newMinimiseButton = createDOMElement('div');
    ...
    if (properties.canMaximise) {
      let newMaximiseButton = createDOMElement('div');
    ...
    let newCloseButton = createDOMElement('div');
 ...
 let createBody = function() {
   let newBody = createDOMElement('div');
       newBody.classList.add('modal-body');

    let newInnerBody = createDOMElement('div');
 ...
 let createFooter = function() {
   let newFooter = createDOMElement('div');
       newFooter.classList.add('modal-footer');
   let newInnerFooter = createDOMElement('div');
